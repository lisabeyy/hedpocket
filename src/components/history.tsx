            ...
            >
              <div className="flex-shrink-0">
                {!e.icon &&
                  <>
                    ...
                    <span className="rounded-full" >{e.tokenName} </span>
                  </>
                ...
                {e.icon &&
                  <>
                    ...
                    <img className="rounded-full" width={24} height={24} src={`https://www.saucerswap.finance/${e.icon}`} alt="" />
              ...
              <div className="min-w-0 flex-1">
                <a href="#" className="focus:outline-none">
                  ...
                  <p className="text-sm font-medium text-gray-900">{capitalizeFirstLetter(e.type)} </p>
                  <p className="truncate text-sm text-gray-500">{e.transferAmount.toFixed(2)}</p>
                  <span className="truncate text-xs text-gray-400">${e.priceChange.toFixed(2)} </span>

                </a>
              </div>
              <div className="flex-2">
                <p className="text-sm font-medium text-gray-800">{new Date(Number(e.consensus_timestamp * 1000)).toLocaleTimeString()}</p>
                <p className="text-xs font-normal text-gray-500">{new Date(Number(e.consensus_timestamp * 1000)).toLocaleDateString()}</p>
